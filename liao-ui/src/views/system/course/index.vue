<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="课程编号" prop="cpno">
        <el-input
  ...
  <el-table-column label="课程名称" key="cname" align="center" prop="cname" />
  <el-table-column label="课程编号" key="cpno" align="center" prop="cpno" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="课程编号" prop="cpno">
          <el-input v-model="form.cpno" placeholder="请输入课程编号" />
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除课程编号为"' + cnos + '"的数据项?', "警告", {
