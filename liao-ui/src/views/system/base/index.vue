<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="类别" prop="baseType">
        <el-input
    ...
    <el-table v-loading="loading" :data="baseList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="基地名称" key="baseName" align="center" prop="baseName"/>
      <el-table-column label="类别" key="baseType" align="center" prop="baseType"/>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="类别" prop="baseType">
          <el-input v-model="form.baseType" placeholder="请输入基地名称"/>
        </el-form-item>
...
<script>
import {listBase, getBase, delBase, addBase, updateBase, exportBase} from "@/api/system/base";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除实训基地编号为"' + baseIds + '"的数据项?', "警告", {
