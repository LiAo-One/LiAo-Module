<template>
  ...
  <el-table-column label="产品id" key="cPid" align="center" prop="cPid" />
  <el-table-column label="评价内容" key="cdesc" align="center" prop="cdesc" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="评价内容" prop="cdesc">
          <el-input v-model="form.cdesc" type="textarea" placeholder="请输入内容" />
        </el-form-item>
...
<script>
import { listCommit, getCommit, delCommit, addCommit, updateCommit, exportCommit } from "@/api/system/commit";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除溯源产品评价编号为"' + cIds + '"的数据项?', "警告", {
          confirmButtonText: "确定",
          cancelButtonText: "取消",
          type: "warning"
        }).then(function() {
          return delCommit(cIds);
        }).then(() => {
          this.getList();
