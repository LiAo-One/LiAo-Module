<template>
  ...
  <el-table-column label="教师姓名" key="name" align="center" prop="name" />
  <el-table-column label="编号" key="cid" align="center" prop="cid" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="编号" prop="cid">
          <el-input v-model="form.cid" placeholder="请输入编号" />
        </el-form-item>
